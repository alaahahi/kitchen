...
const store = new Vuex.Store({
    state: {
        ...
        langFilter: Vue.$cookies.get("selectedlang") ? Vue.$cookies.get("selectedlang") : 'ar', // localStorage.getItem("userWeb") ? (JSON.parse(localStorage.getItem("userWeb"))).nationality :
