...
<section class="characters-you-follow  bg-white p-5" style="direction: ltr;">
                ...
                <h1 class="display-2  fs-1 py-2 fw-bold">أفضل المؤسسات في الشهر الماضي</h1>
                ...
                <div class="container ">
                    ...
                    <div class="row" v-if="bestCompanyLastMonth.length">
                        <div class="col text-center">
                            <router-link class="text-decoration-none text-primary fw-bold fs-5"  to="/companies=best">تصفح المزيد </router-link>
                        </div>
                    </div>
                </div>
</section>
