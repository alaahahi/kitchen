    ...
    <div class="container-fluid bg-adv">
        <div>
            <div class="text-center m-auto py-4">
                <h2 class="text-center text-gray-900 fw-bold py-1">باقات الاشتراك</h2>
                <breadcrumb :data=breadcrumbLsit :center="true"/>
            </div>
        </div>
        <template>
    <div class="fixbg" style="background-image:url('web-asset/img/path104.png');background-position: top;" v-if="!userSubscriptionIsGoldSub()">
        <section class="subscriptionTypes">
            <div class="container text-center mb-3 pt-5">
                <h1 class="fs-1 py-4 fw-bold">إستمتع بتصفح وإضافات مميزات <div class="position-relative text-fix">
                        <div style="background-image: url('web-asset/img/Path 14.png')" class="text-price"></div>
                        غير محدوده
                    </div>
                </h1>
                <h2 class="display-4 py-4 mb-3 text" style="color:#50526B;font-size: 20px;">إحصل على تحكم ومشاهدات افضل من خلال المميزات المختلفه التي نوفرها لك</h2>
            </div>
            <div id="sub"></div>
...
<style >
.subscriptionTypes {
    background-image: linear-gradient(rgba(255, 255, 255, 0.87), #fff);
    margin-bottom: -25px;
}
