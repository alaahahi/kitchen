  ...
  <div class="container-fluid bg-adv">
    <div>
      <div style="background-color: rgb(255 255 255 / 80%)">
        <section class="Discover row bg-serach j-margin-top-negative-descover">
    ...
    <div class="container">
      <div class="row">
                            ...
                            <div class="accordion-body">
                              <div class="form-check">
                                <input
                                  ...
                                  selected
                                />
                                <label class="form-check-label fs-16 fw-bold text-gray-60" for="male"> ذكر </label>
                              </div>
                              <div class="form-check">
                                <input
                                  class="form-check-input"
                                  ...
                                  "
                                />
                                <label class="form-check-label fs-15 fw-bold text-gray-60" for="famele"> أنثى </label>
                              </div>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                <i data-bs-dismiss="modal" aria-label="Close" ref="closeDisabledModal"
                                  ><svg
                                    style="border-radius: 50%;position: relative;top: 2px;top: -31px;width: 31px;right: -32px;
        ...
        <div class="col-md-9 mt-1">
          ...
          <cardAllSelected :categories="categories" v-if="categories != null && !loadingR"/>
        </div>
      </div>
    </div>
    <div></div>
...
import cardAllSelected from './accessories/advancedSearch/cardAllSelected.vue'
...
export default {
  ...
  methods: {
    ...
    getResults() {
      ...
      this.http
        .get(
          '/category_lists_one_request?slug=' +
        ...
        .then(async (response) => {
          ...
          this.categoryName = response.data.category_object.name
          ...
          this.breadcrumbLsit = [
            ...
            {
              name: response.data.category_object.name,
