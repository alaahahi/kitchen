      ...
      <slide v-for="(charactour, index) in categorys" :key="index" class="rounded-5 col-md-3 mt-4 ps-4">
        <div class="card shadow m-1 rounded-btn-img p-1">
          <div class="position-relative p-1 rounded-btn-img">
            ...
            />
            <div
              class="position-absolute custom-p translate-middle"
              :class="charactour.vip_person ? '' : 'd-none-s'"
            >
              <h5>
          ...
          <div class="text-center pb-1" style="min-height: 115px">
            ...
            >
              <h3 class="card-title mb-1 fs-4 fw-bold" style="color: #212529">
                {{ charactour.name }}
              </h3>
              <p
                class="m-0 text-muted fw-bold fs-16"
                v-if="fixContent(charactour.content)"
              >
