                                ...
                                <div class="card m-auto text-end  border-none shados">
                                    <div class="d-sm-flex d-block align-items-start p-2">
                                        <div class="text-center-m-c">
                                            <a   :href="'/شركات/'+decodeURI(result.slug)+'/'"  @click="logSuccessSearch(1,result.id)" >
                                                <div class="position-relative p-1 rounded-btn">
                                                    <app-image 
                                                    lazy-src="/web-asset/img/noResultC.png"
                                                    class="rounded-btn"
                                                    data-background-image="/web-asset/img/noResultC.png"
                                        ...
                                        <div class="card-body pt-2 pb-0 text-center-m">
                                                <a  @click="logSuccessSearch(1,result.id)" :href="'/شركات/'+decodeURI(result.slug)+'/'"
