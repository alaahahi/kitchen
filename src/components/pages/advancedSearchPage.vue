  ...
  <div class="container-fluid bg-adv">
    <div>
      <div style="background-color: rgb(255 255 255 / 80%)">
        <section class="Discover mb-4 row bg-serach j-margin-top-negative-descover">
              ...
              <div class="row height d-flex justify-content-center align-items-center text-center-m">
                <div class="position-relative">
                  <div class="rounded-btn-img search">
                    ...
                    <input
                      @input="debounce(() => { getResults(), q=$event.target.value} , 500);"
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <div class="card border shados">
            ...
            <div  class="accordion-item bg-white">
              ...
              <div v-if="text" class="accordion-item bg-white">
                  ...
                  <div class="accordion-body">
                    <div class="form-check">
                      <input
                        ...
                        value="show_charactours"
                        type="radio"
                        name="flexRadioDefault"
                        id="flexRadioDefault1"
                        :checked="selectSearch == 1"
                        @change="
                          skip = 0;
                          selectSearch = 1;
                        ...
                        "
                      />
                      <label class="form-check-label fs-16 fw-bold text-gray-60" for="flexRadioDefault1">
                        شخصيات
                        <span> ({{ results_count_charactours }}) </span>
                      </label>
                    </div>
                    <div class="form-check">
                      <input
                        ...
                        "
                      />
                      <label class="form-check-label fs-16 fw-bold text-gray-60" for="flexRadioDefault2">
                        مؤسسات
                        <span> ({{ results_count_companies }}) </span>
                      </label>
                    </div>
                    <div class="form-check">
                      <input
                        ...
                        "
                      />
                      <label class="form-check-label fs-16 fw-bold text-gray-60" for="flexRadioDefault3">
                        تصنيفات
                        <span> ({{ results_count_categories }}) </span>
                      </label>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div class="accordion-body">
                    <div class="form-check">
                      ...
                      <label class="form-check-label fs-16 fw-bold text-gray-60" for="flexRadioDefault1">
                        شخصيات
                        <span> ({{ resultsMostSearchCharactour_total}}) </span>
                      </label>
                    </div>
                    <div class="form-check">
                      <input
                        class="form-check-input"
                        value="show_companiesH"
                        :checked="selectSearch == 5 "
                        type="radio"
                        name="flexRadioDefault"
                        id="flexRadioDefault2"
                        @change="
                      ...
                      <label class="form-check-label fs-16 fw-bold text-gray-60" for="flexRadioDefault2">
                        مؤسسات
                        <span> ({{ resultsMostSearchCompany_total }}) </span>
                      </label>
                    </div>
                    <div class="form-check">
                      <input
              ...
              <section v-if="selectSearch == 1 || selectSearch == 2 || selectSearch == 4 || selectSearch == 5">
                <!-- النوع مفعل -->
                <div
                  class="accordion-item bg-white"
                  v-if="allow_filter.includes('الجنس') &&  (selectSearch == 1 || selectSearch == 4) && !not_active_filters.includes('الجنس')"
                >
                  <h2 class="accordion-header bg-white" id="headingOne">
                    <button
                      class="accordion-button bg-white text-gray-900 pb-0 fw-bold fs-5"
                    ...
                    <div class="accordion-body">
                      <div class="form-check">
                        ...
                        <label class="form-check-label fs-16 fw-bold text-gray-60" for="male">
                          ذكر
                          <span v-if="selectSearch == 1"> ({{ total_for_male }}) </span>
                          <span v-if="selectSearch == 4"> ({{ resultsMostSearcMale_total }}) </span>
                      ...
                      <div class="form-check">
                        ...
                        <label class="form-check-label fs-15 fw-bold text-gray-60" for="famele">
                          أنثى
                          <span  v-if="selectSearch == 1"> ({{ total_for_female }}) </span>
                          <span v-if="selectSearch == 4"> ({{ resultsMostSearchFemale_total }}) </span>
                        </label>
                      </div>
                    </div>
                  </div>
                ...
                <!-- الفئة العمرية -->
                <div
                  v-if="allow_filter.includes('العمر') &&  (selectSearch == 1 || selectSearch == 4) && !not_active_filters.includes('العمر')"
                >
                ...
                >
                  ...
                  <div class="m-3 pe-1 fs-16">
                    <p class="text-gray-900 fw-bold pb-0 fs-16" v-if="
                    (allow_filter.includes('الجنسية') || allow_filter.includes('بلد الإقامة')) 
                  ">البلد</p>
                    ...
                    <div @click="openModal()" class="position-relative">
                      ...
                      <div class="position-absolute translate-middle j-lock-position"
                      v-if="!allow_filter.includes('بلد الإقامة') && !not_active_filters.includes('بلد الإقامة')"
                ...
                <!-- البلد شركات-->
                <div
                  v-if="allow_filter.includes('الدولة') &&  (selectSearch == 2 || selectSearch == 5) && !not_active_filters.includes('الدولة')"
                >
                ...
                <div
                  class="accordion-item bg-white"
                  v-if="
                    allow_filter.includes('التصنيف') &&  (selectSearch == 1 || selectSearch == 4) && !not_active_filters.includes('التصنيف')
                  "
                >
                  <h2 class="accordion-header bg-white" id="headingOne">
                    <button
                    ...
                    <div class="accordion-body">
                      ...
                      <div v-for="cat in category" :key="cat.id">
                        <div class="form-check">
                          ...
                          />
                          <label class="form-check-label fs-16 fw-bold text-gray-60" :for="cat.id">
                            {{ cat.phrase }}
                          </label>
                        </div>
                      </div>
                      <div v-for="cat in favoriteCategory" :key="cat.id">
                        <div class="form-check">
                          <input
                            class="form-check-input"
                            :value="cat.id"
                      ...
                      <div v-for="cat in category" :key="cat.id">
                        <div class="form-check">
                          <input
                            ...
                            disabled
                          />
                          <label class="form-check-label fs-16 text-disabled-content" :for="cat.id">
                            {{ cat.phrase }}
                          </label>
                        </div>
                      </div>
                ...
                <div
                  class="accordion-item bg-white"
                  v-if="
                    allow_filter.includes('التصنيف') &&  (selectSearch == 2 || selectSearch == 5) && !not_active_filters.includes('التصنيف')
                  "
                >
                  <h2 class="accordion-header bg-white" id="headingOne">
                    <button
                ...
                <!-- قوائم خاصة / تصنيفات خاصة شخصيات -->
                <div
                  class="accordion-item bg-white"
                  v-if="
                    allow_filter.includes('تصنيفات خاصة\\ قوائم خاصة') &&
                    (selectSearch == 1 || selectSearch == 4) &&
                    !not_active_filters.includes('تصنيفات خاصة\\ قوائم خاصة')
                  "
                >
                  ...
                  >
                    <div class="accordion-body">
                      <div v-for="cat in Scategorys" :key="cat.id_inside_property">
                        <div class="form-check">
                          <input
                            class="form-check-input"
                            :value="cat.id_inside_property"
                            type="checkbox"
                            :id="cat.id_inside_property"
                            v-model="filterCategoryArray"
                            :checked="filterCategoryArray.includes(cat.id_inside_property)"
                            @change="onChange_private($event)"
                          />
                          <label class="form-check-label fs-16 fw-bold text-gray-60" :for="cat.id_inside_property">
                            {{ cat.name }}
                          </label>
                        </div>
                      </div>
                ...
                <!-- قوائم خاصة / تصنيفات خاصة غير مفعل شخصيات-->
                <div
                  class="accordion-item bg-white"
                  @click="openModal()"
                  v-if="
                ...
                <!-- قوائم خاصة / تصنيفات خاصة شركات -->
                <div
                  class="accordion-item bg-white"
                  v-if="
                    allow_filter.includes('تصنيفات خاصة\\ قوائم خاصة') &&
                    (selectSearch == 2 || selectSearch == 5) &&
                    !not_active_filters.includes('تصنيفات خاصة\\ قوائم خاصة')
                  "
                >
                  <h2 class="accordion-header bg-white" id="headingScat">
                ...
                <!-- قوائم خاصة / تصنيفات خاصة غير مفعل شركات-->
                <div
                  class="accordion-item bg-white"
                  @click="openModal()"
                  v-if="
                ...
                <div
                  class="accordion-item bg-white"
                  v-if="
                    allow_filter.includes('التعليم') &&  (selectSearch == 1 || selectSearch == 4) && !not_active_filters.includes('التعليم')
                  "
                >
                      ...
                      <div v-for="inist in favoriteInistitute" :key="inist.id">
                        <div class="form-check">
                          <input
                            ...
                            :id="inist.id"
                            :checked="
                              filterInistituteArray.includes(inist.name) || filterInistituteArray.includes(inist.phrase)
                            "
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        <i data-bs-dismiss="modal" aria-label="Close" ref="closeDisabledModal"
                          ><svg style="border-radius: 50%;position: relative;top: 2px;top: -31px;width: 31px;right: -32px;background: rgb(255, 255, 255);padding: 3px;"
                            viewBox="0 0 32 32"
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                        ...
                        <div class="w-100 d-flex justify-content-center align-items-center">
                          <span class="modal-header-text" v-if="user && !user.complete">اكمل معلومات حسابك</span>
                          <span class="modal-header-text" v-if="!user"> غير متوفر للزائرين</span>
                          <span class="modal-header-text" v-if="user && user.complete && userSubscriptionIsGoldSub()"
                      ...
                      <div class="modal-body d-flex alig-items-center justify-content-center">
                        <div class="w-75 text-center">
                          ...
                          <template v-if="user && !user.complete">
                            <span>
                              يرجى إكمال المعلومات الملف الشخصي لتتمكن من الاستفادة من خدمة فلترة نتائج البحث</span
                            >
                          </template>
        ...
        <div class="col-md-9  mt-1" v-if="text">
          <div v-if="selectSearch == 1">
            <h2 class="fw-bold py-3">الشخصيات</h2>
            <div class="d-flex justify-content-center text-center w-auto mx-auto my-5" v-if="loadingR && resultsCharactour.length == 0">
            <div class="text-center"  :class="{ 'spinner-border spinner-border-lx text-primary': loadingR }" ></div>
            </div>
            <div v-if="resultsCharactour.length > 0">
              <cardCharactour :resultsCharactour="resultsCharactour" />
            </div>
            <div
              class="d-flex justify-content-center text-center w-auto mx-auto my-4"
              v-if="resultsCharactour.length > 0"
            >
              <paginator 
                ...
                :count="results_count_charactours"
                :total="resultsCharactour"
                @getMoreResults_from_child="getMoreResults_from_child"
                >
              </paginator>
            </div>
            <notfoundRsultes :show="resultsCharactour.length == 0 && !loadingR" />
          </div>
          <div v-if="selectSearch == 2">
            <h2 class="fw-bold py-3">الشركات</h2>
            <div class="d-flex justify-content-center text-center w-auto mx-auto my-5" v-if="loadingR">
            <div class="text-center"  :class="{ 'spinner-border spinner-border-lx text-primary': loadingR }" ></div>
            </div>
            <div v-if="resultsCompany.length && !loadingR ">
              <cardCompany :resultsCompany="resultsCompany" />
            </div>
            <div class="d-flex justify-content-center text-center w-auto mx-auto my-4" v-if="resultsCompany.length > 0">
              <paginator 
                :prevResults="prevResults"
                :nextResults="nextResults"
                :skip="skip"
                :item_per_page="item_per_page" 
                :count="results_count_companies"
                :total="resultsCompany"
                @getMoreResults_from_child="getMoreResults_from_child"
                >
              </paginator>
            </div>
            <notfoundRsultes :show="resultsCompany.length == 0 && !loadingR" />
          </div>
          <div v-if="selectSearch == 3">
            <h2 class="fw-bold py-3">التصنيفات</h2>
            <div class="d-flex justify-content-center text-center w-auto mx-auto my-5" v-if="loadingR ">
            <div class="text-center"  :class="{ 'spinner-border spinner-border-lx text-primary': loadingR }" ></div>
            </div>
            <div v-if="resultsCategory.length ">
              <cardAllCatSearch :resultsCategory="resultsCategory" />

              <div
                class="d-flex justify-content-center text-center w-auto mx-auto my-4"
                v-if="resultsCategory.length > 0"
              >
                <paginator 
                :prevResults="prevResults"
                :nextResults="nextResults"
                :skip="skip"
                :item_per_page="item_per_page" 
                :count="results_count_categories"
                :total="resultsCategory"
                @getMoreResults_from_child="getMoreResults_from_child"
                >
              </paginator>
              </div>
            </div>
            <notfoundRsultes :show="resultsCategory.length == 0 && !loadingR" />
          </div>
        </div>

        <div class="col-md-9 mt-1" v-if="!text">
          <div v-if="selectSearch == 4">
            <h2 class="fw-bold py-3">الشخصيات الأكثر بحثاََ</h2>
            <div v-if="resultsMostSearchCharactour">
              <cardCharacterCat :resultsCharactour="resultsMostSearchCharactour" />
            </div>
            <div class="d-flex justify-content-center text-center w-auto mx-auto my-4" >
              ...
              <paginator 
                ...
                :skip="skip"
                :item_per_page="item_per_page" 
                :count="resultsMostSearchCharactour_total"
                :total="resultsMostSearchCharactour"
                @getMoreResults_from_child="getMostSearch_from_child"
                >
              </paginator>
            </div>
            <notfoundRsultes :show="false" />
          </div>
          <div v-if="selectSearch == 5">
            <h2 class="fw-bold py-3">الشركات الأكثر بحثاََ</h2>
            <div v-if="resultsMostSearchCompany">
              <cardCompanyH :resultsCompany="resultsMostSearchCompany" />
            </div>
            <div class="d-flex justify-content-center text-center w-auto mx-auto my-4">
              <!-- <button
                @click="getMoreResults(prevResults)"
              ...
              <paginator 
                ...
                :skip="skip"
                :item_per_page="item_per_page" 
                :count="resultsMostSearchCompany_total"
                :total="resultsMostSearchCompany"
                @getMoreResults_from_child="getMostSearch_from_child"
                >
              </paginator>
            </div>
          ...
          <div v-if="selectSearch == 6">
            <h2 class="fw-bold py-3">جميع التصنيفات</h2>
            <cardAllCat />
            <notfoundRsultes :show="false" />
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      resultsMostSearchCharactour_count:0,
      resultsMostSearchCompany_count:0,
      resultsMostSearchCategories_count:0,
      favoriteDegree: [],
      favoriteInistitute: [],
      favoriteCategory: [],
  ...
  methods: {
    ...
    getMoreResults_from_child(value){
      ...
      this.getMoreResults(value)
    },
    getMostSearch_from_child(value){
      this.getMostSearchResults(value)
    },
    ...
    restFilter() {
      ...
      this.resultsMostSearchCharactour_count = 0
      this.resultsMostSearchCompany_count = 0
      this.resultsMostSearchCategories_count = 0
      this.favoriteDegree = []
    ...
    getSCategory() {
      if (this.selectSearch == 4 || this.selectSearch == 1) this.type = 'character'
      if (this.selectSearch == 5 || this.selectSearch == 2) this.type = 'company'
      this.http
        .get('/category/getCategoriesByCountry?code=' + this.code+ '&type='+ this.type)
        .then(async (response) => {
    ...
    getResults() {
      if(this.selectSearch == 4 || this.selectSearch == 5){ this.getMostSearchResults() }
      if (this.text) {
        this.loadingR=true
    ...
    onChange(event) {
      ...
      if (index !== -1) {
        ...
        this.filterCategoryArray.push(data)
      }
      this.getResults()
    },
    onChange_private(event) {
      var data = event.target.value
      var index = this.filterCategoryArray.indexOf(data)
      if (index !== -1) {
        this.filterCategoryArray.splice(index, 1)
    ...
    getMostSearchResults(v=0) {
      this.skip = this.skip + v
      if (this.selectSearch == 4) this.type = 'character'
      if (this.selectSearch == 5) this.type = 'company'
      if (this.skip != 0) {
        this.prevResults = this.item_per_page * -1;
      }
      if (this.skip == 0) {
      ...
      this.http
        ...
        .then(async (response) => {
          this.resultsMostSearchCharactour = response.data.result
          this.resultsMostSearchCompany = response.data.result
